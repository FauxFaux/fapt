...
struct Cli {
    ...
    #[clap(short = 'c', long, short, value_name = "DIRECTORY")]
    cache_dir: Option<PathBuf>,
    /// a sources.list entry, e.g. 'debs http://deb.debian.org/debian sid main contrib'
    #[clap(short = 'r', long, short, value_name = "LINE", num_args = 1)]
...
mod tests {
    ...
    fn test_clap_rage() {
        ...
        let matches: TestCli = TestCli::parse_from(vec!["test", "-v", "a", "update"]);
        assert_eq!(matches.vals, Some(vec!["a".to_string()]));
    }
}
